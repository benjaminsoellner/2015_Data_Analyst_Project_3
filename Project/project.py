...
def run_zipcode_map():
    print "Downloading and importing the zipcode helper data..."
    zipcode_map.zipcode_map(ZIPURL, ZIPURLFILE, ZIPFOLDER, MONGOSERVER, MONGOPORT)
...
def run_audit_zipcode_map():
    print "Auditing data quality of zipcodes..."
    audit_zipcode_map.audit_zipcode_map(MONGOSERVER, MONGOPORT)
...
if __name__ == "__main__":
    optlist, _ = getopt.gnu_getopt(sys.argv, 'dpzfswrqZcC')
    ...
    if len(options) == 0:
        ...
        print "  python project.py -z    Download and install the zipcode helpers"
        ...
        print "  python project.py -Z    Audit quality of data: Zipcodes - (see -z option)"
